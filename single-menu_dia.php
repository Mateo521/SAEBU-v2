...
<div class="min-h-screen bg-[#f8fafc] py-12 px-4 font-sans text-slate-900">
    ...
    <div class="max-w-6xl mx-auto mt-12 text-center">
        <button id="btn-suscribir-single" class="inline-flex items-center gap-3 px-10 py-4 bg-slate-900 text-white rounded-full text-xs font-bold uppercase tracking-[0.2em] hover:bg-[#005eb8] transition-all transform hover:scale-105 shadow-lg shadow-slate-300">
