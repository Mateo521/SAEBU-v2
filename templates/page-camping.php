...
<main class="department-page camping-page">
    <div class="container">
        ...
        <section class="department-news">
            <h2>Noticias de Camping</h2>
            
            <div class="news-list">
                <?php
                $noticias = saebu_get_noticias_by_departamento('camping', 10);
            ...
            <div class="view-all-news">
                <a href="<?php echo home_url('/camping/noticias'); ?>" class="btn-primary">
