...
<main class="bg-gray-50">
    ...
    <?php while (have_posts()) : the_post(); ?>
        ...
        <section class="relative bg-[#1a4731] text-white py-20 border-b-4 border-green-600 overflow-hidden">
            ...
            ?>
            <img fetchpriority="high" class="absolute inset-0 w-full h-full object-cover opacity-70 mix-blend-overlay" src="<?php echo esc_url($hero_image); ?>" alt="Paisaje La Florida">
