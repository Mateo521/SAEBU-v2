    ...
    <div class="container mx-auto px-6 py-20 max-w-7xl">
        <div class="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-16">
            ...
            <div class="md:col-span-4 lg:col-span-3">
                <h3 class="text-sm font-bold text-white uppercase  mb-6">Contacto</h3>
                <ul class="space-y-6 text-sm font-light">
                    <li>
                        <span class="block text-sm uppercase  text-slate-500 mb-1">Dirección</span>
                        <span class="text-slate-300">Rivadavia 1029<br>San Luis Capital (D5700)</span>
                    </li>
                    <li>
                        <span class="block text-sm uppercase  text-slate-500 mb-1">Teléfono</span>
                        <a href="tel:02664520300" class="text-slate-300 hover:text-white transition-colors">(0266) 452-0300 Int. 8139</a>
                    </li>
                    <li>
                        <span class="block text-sm uppercase  text-slate-500 mb-1">Correo Electrónico</span>
            ...
            <div class="md:col-span-4 lg:col-span-2">
                <h3 class="text-sm font-bold text-white uppercase  mb-6">Áreas</h3>
            ...
            <div class="md:col-span-4 lg:col-span-3">
                <h3 class="text-sm font-bold text-white uppercase  mb-6">Institucional</h3>
                <ul class="space-y-3 text-sm font-light">
