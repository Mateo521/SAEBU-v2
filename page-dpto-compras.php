    ...
    <?php while (have_posts()) : the_post(); ?>
            ...
            <div class="container mx-auto px-6 max-w-7xl">
                <div class="grid md:grid-cols-[1.5fr_1fr] gap-16 items-start">
                    ...
                    <div class="md:pl-12 md:border-l border-slate-200">
                        <h3 class="text-sm font-bold text-slate-400 uppercase  mb-6">Áreas asistidas</h3>
                        <ul class="space-y-4">
            ...
            <div class="container mx-auto px-6 max-w-7xl">
                ...
                <div class="grid md:grid-cols-3 gap-12">
                    <div class="border-t border-slate-300 pt-6 group">
                        <span class="text-sm font-bold text-[#005eb8] uppercase  mb-3 block">Alta complejidad</span>
                    ...
                    <div class="border-t border-slate-300 pt-6 group">
                        <span class="text-sm font-bold text-[#005eb8] uppercase  mb-3 block">Respuesta rápida</span>
                    ...
                    <div class="border-t border-slate-300 pt-6 group">
                        <span class="text-sm font-bold text-[#005eb8] uppercase  mb-3 block">Planificación</span>
        ...
        <section class="py-20 bg-[#005eb8] text-white text-center">
            <div class="container mx-auto px-6 max-w-4xl">
                <h2 class="text-sm font-bold uppercase  text-blue-200 mb-4">Acceso a Proveedores</h2>
        ...
        <section class="bg-slate-900 py-24 text-white text-center">
            <div class="container mx-auto px-6 max-w-3xl">
                ...
                <div class="mb-12 inline-block">
                    ...
                    <p class="text-sm text-[#005eb8] uppercase  font-bold">Jefa de Departamento de Compras</p>
                </div>
