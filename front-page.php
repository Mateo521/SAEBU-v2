            ...
            <div class="order-2 md:order-1">
                ...
                <ul class="space-y-4 mb-8">
                    <li class="flex items-start gap-3">
                        <svg class="w-6 h-6 text-[#005eb8] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                    ...
                    <div class="aspect-video bg-gray-900 relative group overflow-hidden">
                        ...
                        <div class="absolute inset-0 flex items-center justify-center bg-black/30 group-hover:bg-black/20 transition-all cursor-pointer" id="play-pause-btn">
                            <div class="w-16 h-16 bg-white/90 rounded-full flex items-center justify-center shadow-md hover:scale-105 transition-transform play-icon">
                                <svg class="w-6 h-6 text-[#005eb8] ml-1" fill="currentColor" viewBox="0 0 24 24"><path d="M8 5v14l11-7z"/></svg>
                            </div>
                        </div>
                    </div>
                </div>
...
<section class="py-20 bg-white">
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
            <?php 
            $departamentos = array(
                ['name' => 'Becas', 'slug' => 'becas', 'desc' => 'Programas de apoyo económico.', 'icon' => 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z'],
                ['name' => 'Salud Estudiantil', 'slug' => 'ceseu', 'desc' => 'Atención primaria y prevención.', 'icon' => 'M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z'],
                ['name' => 'Deportes', 'slug' => 'dpto-deportes', 'desc' => 'Recreación y competencia.', 'icon' => 'M13 10V3L4 14h7v7l9-11h-7z'],
                ['name' => 'Comedor', 'slug' => 'comedor', 'desc' => 'Alimentación saludable y accesible.', 'icon' => 'M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z'],
                ['name' => 'Trabajo Social', 'slug' => 'trabajo-social', 'desc' => 'Orientación y acompañamiento.', 'icon' => 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z'],
                ['name' => 'Administración', 'slug' => 'administracion', 'desc' => 'Gestión de trámites.', 'icon' => 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z']
            );
                ...
                <a href="<?php echo home_url('/' . $depto['slug']); ?>" 
                   class="group bg-white border border-gray-200 rounded-md p-6 hover:border-[#005eb8] hover:shadow-md transition-all duration-300 flex items-start gap-4">
                    <div class="text-gray-400 group-hover:text-[#005eb8] transition-colors">
                        <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="<?php echo $depto['icon']; ?>"></path></svg>
                    </div>
                    <div>
