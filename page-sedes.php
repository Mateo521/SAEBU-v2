            ...
            <div class="container mx-auto px-4">
                <div class="grid md:grid-cols-3 gap-8 max-w-7xl mx-auto">
                    ...
                    <article class="bg-white rounded-lg shadow-sm hover:shadow-2xl transition-all duration-300 border border-gray-200 overflow-hidden flex flex-col group">
                        ...
                        <div class="p-8 flex-1 flex flex-col">
                            <div class="flex items-center justify-between mb-6">
                                ...
                                <span class="text-xs font-bold uppercase tracking-wider text-gray-400 border border-gray-200 px-2 py-1 rounded">Sede Central</span>
                            </div>
                            ...
                            <div class="space-y-3 mb-8 flex-1">
                                <div class="flex items-start gap-3 text-sm text-gray-600">
                                    ...
                                    <span>Rivadavia 1029, 1º Piso</span>
                                </div>
                                <div class="flex items-start gap-3 text-sm text-gray-600">
                                    <svg class="w-5 h-5 text-gray-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div class="flex items-start gap-3 text-sm text-gray-600">
                                    ...
                                    <span class="break-all">saebu@unsl.edu.ar</span>
                                </div>
                            </div>
                    ...
                    <article class="bg-white rounded-lg shadow-sm hover:shadow-2xl transition-all duration-300 border border-gray-200 overflow-hidden flex flex-col group">
                        ...
                        <div class="p-8 flex-1 flex flex-col">
                            <div class="flex items-center justify-between mb-6">
                                ...
                                <span class="text-xs font-bold uppercase tracking-wider text-gray-400 border border-gray-200 px-2 py-1 rounded">Sede Regional</span>
                            </div>
                    ...
                    <article class="bg-white rounded-lg shadow-sm hover:shadow-2xl transition-all duration-300 border border-gray-200 overflow-hidden flex flex-col group">
                        ...
                        <div class="p-8 flex-1 flex flex-col">
                            <div class="flex items-center justify-between mb-6">
                                <div class="w-14 h-14 bg-teal-50 text-teal-600 rounded-lg flex items-center justify-center group-hover:bg-teal-600 group-hover:text-white transition-colors">
                                    <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <a href="<?php echo home_url('/saebu-merlo'); ?>" class="block w-full text-center py-3 rounded-md bg-teal-600 text-white font-semibold hover:bg-teal-700 transition-all shadow-md hover:shadow-lg">
                                Ir a Sede Merlo
                            </a>
                        </div>
                    </article>
                ...
                <div class="max-w-4xl mx-auto bg-slate-50 rounded-2xl p-8 border border-gray-200">
                    <div class="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16">
                        <div class="text-center">
                            <div class="w-4 h-4 bg-teal-600 rounded-full mx-auto mb-2"></div>
                            <p class="font-bold text-gray-800">Merlo</p>
                        ...
                        <div class="text-center">
                            ...
                            <p class="font-bold text-gray-800">Villa Mercedes</p>
                            <p class="text-xs text-gray-500">Centro-Este</p>
                        </div>
                    </div>
