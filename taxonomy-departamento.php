        ...
        <div class="container mx-auto px-4">
            <div class="max-w-6xl mx-auto">
                ...
                <div class="flex flex-col md:flex-row items-start justify-between gap-8">
                    <div class="flex-1">
                        <span class="inline-block border border-blue-500/30 bg-blue-500/10 text-blue-300 text-sm font-bold uppercase  px-2 py-1 mb-4">
                            Departamento
                        </span>
                    ...
                    <div class="bg-white/5 border border-white/10 p-6 min-w-[200px] text-center">
                        ...
                        <span class="text-sm text-slate-400 uppercase ">Publicaciones</span>
                    </div>
                </div>
    ...
    <div class="bg-white border-b border-gray-200 sticky top-0 z-30">
        <div class="container mx-auto px-4">
            <div class="max-w-6xl mx-auto flex items-center justify-between py-4">
                ...
                <div class="text-sm font-bold text-slate-400 uppercase  hidden sm:block">
                    Archivo de Noticias
                </div>
            </div>
        </div>
                    ...
                    <div class="flex flex-col gap-8"> <?php while (have_posts()) : the_post(); ?>
                            ...
                            <article class="group bg-white border border-gray-200 hover:border-gray-300 transition-all duration-300 shadow-sm hover:shadow-md flex flex-col md:flex-row overflow-hidden h-full md:h-64">
                                ...
                                <div class="p-6 md:p-8 flex flex-col justify-center flex-1">
                                    ...
                                    <div class="flex items-center gap-4 text-sm font-medium text-gray-500 mb-3 uppercase tracking-wider">
                                    ...
                                    <div class="mt-auto">
                                        <a href="<?php the_permalink(); ?>" class="inline-flex items-center text-sm font-bold uppercase  text-slate-900 border-b-2 border-gray-200 pb-1 hover:border-[#005eb8] hover:text-[#005eb8] transition-all">
                                            Ver más
            ...
            <div class="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
                ...
                <div class="flex gap-4">
                    <a href="<?php echo home_url('/' . $term->slug); ?>" 
                       class="px-6 py-3 bg-white text-[#003366] text-sm font-bold uppercase  hover:bg-gray-100 transition-colors">
                        Ir al Departamento
                    </a>
                </div>
            </div>
