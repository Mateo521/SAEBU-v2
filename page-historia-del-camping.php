    ...
    <section class="relative bg-[#1a4731] text-white py-20 border-b-4 border-green-700">
        ...
        <div class="container mx-auto px-4 relative z-10">
            <div class="max-w-4xl mx-auto text-center">
                <nav class="flex justify-center items-center gap-2 text-sm text-green-200 mb-6" aria-label="Breadcrumb">
                    ...
                    <div class="relative pl-8 md:pl-12">
                        ...
                        <div class="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
                            ...
                            <ul class="grid sm:grid-cols-2 gap-2 text-sm text-gray-500">
                                <li class="flex items-center gap-2"><svg class="w-4 h-4 text-green-600" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
                                    </svg> Planta de agua potable</li>
                                <li class="flex items-center gap-2"><svg class="w-4 h-4 text-green-600" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
                                    </svg> Red eléctrica e iluminación</li>
                            </ul>
                        </div>
                    </div>
...
<div id="lightbox" class="fixed inset-0 bg-slate-900/95 z-50 hidden items-center justify-center p-4 backdrop-blur-sm" role="dialog" aria-modal="true" aria-labelledby="lightbox-title">
    <button id="close-lightbox" class="absolute top-4 right-4 p-2 text-gray-400 hover:text-white transition-colors z-50" aria-label="Cerrar galería">
    ...
    <div class="flex items-center justify-between w-full max-w-7xl gap-4">
        <button id="prev-image" class="p-3 text-gray-400 hover:text-white hover:bg-white/10 rounded-full transition-all" aria-label="Imagen anterior">
            <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <button id="next-image" class="p-3 text-gray-400 hover:text-white hover:bg-white/10 rounded-full transition-all" aria-label="Siguiente imagen">
            <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const imagesData = [{
                ...
                desc: 'Fase I - Preparación del terreno'
            },
