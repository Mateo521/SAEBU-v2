...
<main class="bg-white font-sans">
    ...
    <section class="relative bg-[#1a4731] py-32 border-b border-[#0f2e1f] overflow-hidden text-center">
        ...
        <div class="container mx-auto px-6 max-w-4xl relative z-10">
            ...
            <nav class="flex justify-center items-center gap-3 text-sm font-bold  uppercase text-green-400/70 mb-8">
    ...
    <section class="py-24 bg-white">
        <div class="container mx-auto px-6 max-w-4xl text-center">
            <h2 class="text-sm font-bold uppercase  text-slate-400 mb-6">
        ...
        <div class="container mx-auto px-6 max-w-5xl">
            ...
            <div class="grid md:grid-cols-[1fr_2fr] gap-8 md:gap-16 py-12 border-b border-slate-200 items-start">
                <div class="md:text-right">
                    ...
                    <span class="text-sm font-bold uppercase  text-slate-400">Inicio del Proyecto</span>
                </div>
                <div>
            ...
            <div class="grid md:grid-cols-[1fr_2fr] gap-8 md:gap-16 py-12 border-b border-slate-200 items-start">
                <div class="md:text-right">
                    ...
                    <span class="text-sm font-bold uppercase  text-slate-400">Infraestructura base</span>
                </div>
                <div>
            ...
            <div class="grid md:grid-cols-[1fr_2fr] gap-8 md:gap-16 py-12 border-b border-slate-200 items-start">
                <div class="md:text-right">
                    ...
                    <span class="text-sm font-bold uppercase  text-slate-400">Medio ambiente</span>
                </div>
                <div>
            ...
            <div class="grid md:grid-cols-[1fr_2fr] gap-8 md:gap-16 py-12 border-b border-slate-200 items-start">
                <div class="md:text-right">
                    ...
                    <span class="text-sm font-bold uppercase  text-slate-400">Expansión</span>
                </div>
                <div>
            ...
            <div class="grid md:grid-cols-[1fr_2fr] gap-8 md:gap-16 py-12 items-start">
                <div class="md:text-right">
                    ...
                    <span class="text-sm font-bold uppercase  text-slate-400">Mayo</span>
                </div>
                <div>
    ...
    <section class="py-24 bg-white">
        <div class="container mx-auto px-6 max-w-7xl">
                    ...
                    <div class="gallery-item cursor-pointer group" data-index="<?php echo $index; ?>">
                        ...
                        <div class="aspect-[4/3] bg-slate-100 overflow-hidden mb-4 relative">
                            ...
                            <div class="absolute inset-0 bg-[#1a4731]/0 group-hover:bg-[#1a4731]/20 transition-colors duration-300 flex items-center justify-center">
                                <span class="bg-white/90 text-[#1a4731] text-sm uppercase  font-bold px-4 py-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 transform translate-y-2 group-hover:translate-y-0">
                                    Ampliar
                                </span>
                            </div>
                        </div>
                        ...
                        <div>
                            <div class="flex justify-between items-baseline mb-1">
                                ...
                                <span class="text-sm font-bold text-[#1a4731] uppercase "><?php echo $foto['fecha']; ?></span>
                            </div>
            ...
            <div class="mt-20 pt-8 border-t border-slate-200 text-center">
                <span class="text-sm text-slate-400 font-light uppercase ">
