        ...
        <section class="relative bg-slate-800 text-white py-20 border-b-4 border-emerald-600">
            ...
            <div class="container mx-auto px-4 relative z-10">
                <div class="max-w-4xl mx-auto text-center">
                    <nav class="flex justify-center items-center gap-2 text-sm text-slate-300 mb-6">
                    ...
                    <p class="text-xl text-slate-200 max-w-2xl mx-auto font-light leading-relaxed">
                        Administración, control y gestión financiera de los recursos de la Secretaría para garantizar el funcionamiento de los servicios estudiantiles.
                    </p>
                </div>
            </div>
        </section>
