    ...
    <?php while (have_posts()) : the_post(); ?>
        ...
        <article class="container mx-auto px-4 max-w-4xl py-12 md:py-20">
            ...
            <figure class="mb-12 md:mb-16">
                ...
                ?>
                    <div class="swiper gallery-swiper rounded-sm overflow-hidden border border-gray-100 relative group bg-black">
                        <div class="swiper-wrapper">
                            <?php foreach ($imagenes as $imagen_id) :
                                ...
                                if ($imagen_url) :
                            ?>
                                    <div class="swiper-slide flex items-center justify-center bg-black h-[500px] md:h-[600px] lg:h-[700px]">
                        ...
                        <div class="swiper-button-next !text-white after:!text-lg !bg-black/50 !w-10 !h-10 rounded-full shadow-sm opacity-0 group-hover:opacity-100 transition-opacity"></div>
                        <div class="swiper-button-prev !text-white after:!text-lg !bg-black/50 !w-10 !h-10 rounded-full shadow-sm opacity-0 group-hover:opacity-100 transition-opacity"></div>
                        <div class="swiper-pagination !bottom-4"></div>
                    </div>

                <?php elseif (has_post_thumbnail()) : ?>
                    <div class="rounded-sm overflow-hidden border border-gray-100 bg-black">
                        <?php
