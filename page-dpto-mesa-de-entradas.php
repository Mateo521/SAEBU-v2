                ...
                <div class="max-w-6xl mx-auto">
                    ...
                    <div class="mb-16">
                        <div class="flex items-center gap-3 mb-8">
                            ...
                            <h2 class="text-xl font-bold text-slate-900">Tareas de interés público</h2>
                        </div>
                    ...
                    <div class="mb-16">
                        <div class="flex items-center gap-3 mb-8">
                            ...
                            <h2 class="text-xl font-bold text-slate-900">Contacto</h2>
                        </div>
                    ...
                    <div>
                        <div class="flex items-center gap-3 mb-8">
                            ...
                            <h2 class="text-xl font-bold text-slate-900">Últimas Noticias</h2>
                        </div>
