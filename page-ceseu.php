    ...
    <?php while (have_posts()) : the_post(); ?>
            ...
            <div class="container mx-auto px-6 max-w-7xl">
                ...
                <div class="grid md:grid-cols-2 gap-12">
                    ...
                    <div class="border-t border-slate-200 pt-8">
                        <span class="text-[10px] font-bold text-[#005eb8] uppercase tracking-widest mb-3 block">Sede Capital</span>
                        <h3 class="text-2xl font-medium text-slate-900 mb-6">San Luis</h3>

                        <div class="space-y-4">
                            <div>
                                <span class="block text-xs font-bold text-slate-400 uppercase tracking-widest mb-1">Dirección</span>
                                <p class="text-sm text-slate-700 font-light">Rivadavia 1359 (entre Av. España y Tomás Jofré)</p>
                            </div>
                            <div>
                                <span class="block text-xs font-bold text-slate-400 uppercase tracking-widest mb-1">Horario de Atención</span>
                                <p class="text-sm text-slate-700 font-light">Lunes a viernes de 8:00 a 13:00 hs</p>
                            </div>
                            <div>
                                <span class="block text-xs font-bold text-slate-400 uppercase tracking-widest mb-1">Contacto</span>
                    ...
                    <div class="border-t border-slate-200 pt-8">
                        <span class="text-[10px] font-bold text-[#005eb8] uppercase tracking-widest mb-3 block">Sede Regional</span>
                ...
                <div class="mt-16 pt-8 border-t border-slate-100 flex flex-wrap justify-center gap-x-12 gap-y-4 text-sm font-light text-slate-500">
                    <span class="uppercase tracking-widest text-[10px] font-bold text-slate-400 self-center">Equipo Administrativo:</span>
        ...
        <section class="py-24 bg-slate-50 border-y border-slate-200">
            <div class="container mx-auto px-6 max-w-5xl">
                ...
                <div class="text-center mb-16">
                    <span class="text-[10px] font-bold text-[#005eb8] uppercase tracking-widest mb-4 block">Ingresantes</span>
                ...
                <div class="grid md:grid-cols-3 gap-12 relative">
                    ...
                    <div class="relative z-10 md:mt-12">
                        ...
                        <a href="https://forms.gle/PPMiDUpoN5prNDAA7" target="_blank" class="inline-flex items-center gap-2 text-sm font-bold uppercase tracking-widest text-[#005eb8] border-b border-[#005eb8] pb-1 hover:text-slate-900 hover:border-slate-900 transition-colors">
                        ...
                        <div class="flex flex-col sm:flex-row gap-6 border-b border-slate-100 pb-6">
                            ...
                            <div class="sm:w-2/3 border-l-2 border-[#005eb8] pl-6">
                                ...
                                <p class="text-xs text-slate-500 font-light">
                                    <strong class="uppercase tracking-widest text-[10px] text-slate-400 mr-1">Atención:</strong>
        ...
        <section class="py-16 bg-[#005eb8] text-white">
            <div class="container mx-auto px-6 max-w-5xl flex flex-col md:flex-row items-center justify-between gap-8">
                <div class="md:w-1/3">
                    <h3 class="text-[10px] font-bold uppercase tracking-widest text-blue-200 mb-2">Programa Nacional</h3>
        ...
        <section class="bg-slate-900 py-24 text-white text-center">
            <div class="container mx-auto px-6 max-w-3xl">
                ...
                <div class="mb-12 border-t border-slate-700 pt-8 inline-block">
                    ...
                    <p class="text-xs text-[#005eb8] uppercase tracking-widest font-bold">Coordinadora del CeSEU</p>
                </div>

                <div class="flex flex-col sm:flex-row gap-6 justify-center">
                    <a href="mailto:ceseu.saebu.unsl@gmail.com" class="inline-block bg-white text-slate-900 px-10 py-4 text-sm font-bold uppercase tracking-widest hover:bg-slate-100  transition-all duration-300">
                        Enviar Correo
                    </a>
