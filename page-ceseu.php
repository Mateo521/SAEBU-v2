...
<main class="bg-gray-50">
            ...
            <div class="container mx-auto px-4 relative z-10">
                <div class="max-w-4xl mx-auto text-center">
                    ...
                    <p class="text-xl text-gray-300 max-w-2xl mx-auto font-light leading-relaxed">
                        Brindamos atención primaria de la salud integral y gratuita para estudiantes de la UNSL.
                    </p>
                </div>
            </div>
        </section>
            ...
            <div class="container mx-auto px-4">
                <div class="max-w-6xl mx-auto">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                        <?php 
                        $especialidades = [
                            'Enfermería', 'Medicina General', 'Kinesiología', 
                            'Nutrición', 'Psicología', 'Odontología',
                            'Ginecología', 'Oftalmología', 'Fonoaudiología', 'Análisis Clínicos'
                        ];
                        ...
                        <div class="space-y-6">
                            <div class="bg-gray-50 rounded-lg border border-gray-200 p-6">
                                <h3 class="font-bold text-gray-900 mb-2 flex items-center gap-2">
                                    <svg class="w-5 h-5 text-pink-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
                                    Comedor sin TACC
                                </h3>
    ...
    saebu_noticias_departamento(array(
        'slug'        => 'camping',
        'nombre'      => 'Camping Universitario',
        'color'       => 'green',
        'descripcion' => 'Últimas actividades, reservas y comunicados del camping.',
        'posts_count' => 3,
